...
namespace DykplatserWinPhone.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public void LoadData()
        {
           ...
           //         this.Items.Add(new ItemViewModel() { ID = i.ToString(), LineOne = placemark.Name, LineTwo = "Maecenas praesent accumsan bibendum", LineThree = "Facilisi faucibus habitant inceptos interdum lobortis nascetur pharetra placerat pulvinar sagittis senectus sociosqu" });
           //         i++;
           //     }
           // }
